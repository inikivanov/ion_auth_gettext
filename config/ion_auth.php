 ...
 */
$config['site_title']                 = "Kwoter";               // Site Title, example.com
...
$config['user_expire']                = 86500;                  // How long to remember the user (seconds). Set to zero for no expiration Default 86500
